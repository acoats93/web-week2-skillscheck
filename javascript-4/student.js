...
const faveColors = ['cerulean', 'cobalt blue', 'gray'];
...
let me = {
    firstName: 'Anthony',
    superHeroName: 'Captain Mediocrity',
    homeTown: 'Springfield (but which one???)',
    superPowers: 'The amazing ability to make everyone around him look slightly better by comparison!',
...
//i think i have an error in here^^
...
//use a for-in loop to run through your object ya silly goose!
